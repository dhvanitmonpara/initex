...
export async function promptProjectConfig() {
    ...
    if (!projectName) {
        const nameInput = await text({
            ...
            validate(value) {
                if (!value)
                    return vice("Project name cannot be empty!");
            },
        });
    ...
    if (isCancel(expressVersionInput))
        process.exit(0);
